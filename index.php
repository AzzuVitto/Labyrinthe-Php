...
<body>
    <form method="POST">
        <div class="cross-buttons">
            <button class="cross-button" name="up">↑</button>
            <button class="cross-button" name="left">←</button>
            <button class="cross-button" name="right">→</button>
            <button class="cross-button" name="down">↓</button>
        </div>

        <main>
            <div>
                <button class="btn" name="refresh"><b>REJOUER</b></button>
            </div>
            <table>
                <?php
                    ...
                    foreach ($row as $x => $cell) {
                        switch ($cell) {
                            case 0:
                                ...
                                break;
                            case 1:
                                echo "<td><img class='cat' src='./assets/images/cat.jpg' height='50px' width='50px' alt='Chat'></td>";
                                break;
                            case 2:
                                echo "<td><img src='$wall' height='50px' width='50px' alt='Wall'></td>";
                                break;
                            case 3:
                                echo "<td><img src='$goal' height='50px' width='50px' alt='mouse'></td>";
                                break;
                            case 4:
                                echo "<td><img class ='foggy' src='$fog' height='50px' width='50px' alt='mouse'></td>";
                                break;
                        }
                    }
                    echo '</tr>';
